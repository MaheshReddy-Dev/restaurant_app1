...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference("Dish.count") do
      post dishes_url, params: { dish: { name: @dish.name, price: @dish.price, restaurant_id: @dish.restaurant_id } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { name: @dish.name, price: @dish.price, restaurant_id: @dish.restaurant_id } }
